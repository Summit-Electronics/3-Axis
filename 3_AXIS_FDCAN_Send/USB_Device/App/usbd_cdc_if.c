...
volatile uint8_t enterBootloaderRequested = 0;
...
{
    // For simplicity, only support one command "DFU"
    if(strcmp(cmdLine, "DFU") == 0)
    {
        CDC_Transmit_FS((uint8_t *)"OK - Entering DFU mode...\r\n", 27);
        enterBootloaderRequested = 1;
    }
    else
    {
