...
/**
  ...
  *
  ******************************************************************************
  * Example: 3_AXIS_EMPTY
  * Board: 3-AXIS Stepper Driver
  * Purpose: Empty project provided as template
  */
...
int main(void)
{
  ...
  /* USER CODE BEGIN 2 */
  TMC5160_Drive_Enable(0, 1); // turn off driver 1
  TMC5160_Drive_Enable(0, 2); // turn off driver 2
  TMC5160_Drive_Enable(0, 3); // turn off driver 3
  ...
  /*
   * All 3 axis are setup, ready to be enabled, and start rotations.
   */
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
	HAL_Delay(1000);
	HAL_GPIO_WritePin(LED_GPIO_Port, LED_Pin, 1); // turn off LED
	HAL_Delay(1000);
