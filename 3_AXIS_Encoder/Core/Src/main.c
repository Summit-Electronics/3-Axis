...
/**
  ...
  *
  ******************************************************************************
  * Example: 3_AXIS_Encoder
  * Board: 3-AXIS Stepper Driver
  * Purpose: Demonstrates how the encoder position can be read out while a rotation
  * is in progress. This is best seen by placing a breakpoint in SSM3ST4840C.c
  * function TMC5160_Rotate_To(X,X) on Pos_Reached = 1. once the defined position
  * is reached, the user can view and compare the internal position register to the
  * encoder position register.  (further implementation is up to the user)
  *
  * Encoder resolution can be set as a variable: ENC_Resolution in main.c
  * This resolution is used in ENC_Get_Position() to match the acquired position
  * to the 256 microstepping position register of the TMC5160
  */
...
/* User Settings */
const int ENC_ENB_A1 = 1;  // 0 = disable Encoder , 1 = enable Encoder
const int ENC_ENB_A2 = 1;  // 0 = disable Encoder , 1 = enable Encoder
const int ENC_ENB_A3 = 1;  // 0 = disable Encoder , 1 = enable Encoder
...
const int32_t ENC_Resolution_A1 =  16384; // Encoder resolution
const int32_t ENC_Resolution_A2 =  16384; // Encoder resolution
const int32_t ENC_Resolution_A3 =  16384; // Encoder resolution
