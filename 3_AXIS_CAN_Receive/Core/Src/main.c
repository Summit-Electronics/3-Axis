...
/**
  ...
  *
  ******************************************************************************
  * Example: 3_AXIS_CAN_Receive
  * Board: 3-AXIS Stepper Driver
  * Purpose: Demonstrates communication using CAN bus.
  * This code will listen to incoming CAN bus messages and once CANRxData[0] ==
  * 0x01 has been received, respond back.
  *
  * Baud used: 1Mbps
  */
...
int main(void)
{
  ...
  CANTxHeader.Identifier = 0x222; //ID
